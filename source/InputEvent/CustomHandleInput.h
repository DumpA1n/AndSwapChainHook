...
namespace CustomHandleInput {
    ...
    inline int32_t ImGui_ImplAndroid_HandleInputEvent(const AInputEvent* input_event, const ImVec2 screenSize)
    {
        ImGuiIO& io = ImGui::GetIO();
        // ImVec2 scale = { io.DisplaySize.x / screenSize.x, io.DisplaySize.y / screenSize.y };
        ImVec2 scale = { screenSize.x / io.DisplaySize.x, screenSize.y / io.DisplaySize.y };
        ...
        case AINPUT_EVENT_TYPE_MOTION:
        {
            ...
            case AMOTION_EVENT_ACTION_UP:
            {
                ...
                {
                    io.AddMousePosEvent(AMotionEvent_getX(input_event, event_pointer_index) * scale.x, AMotionEvent_getY(input_event, event_pointer_index) * scale.y);
            ...
            {
                float x = AMotionEvent_getX(input_event, event_pointer_index) * scale.x;
                float y = AMotionEvent_getY(input_event, event_pointer_index) * scale.y;
                // LOGI("coord(%.f, %.f)", x, y);
